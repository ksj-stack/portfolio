		...
		<table border="1" width="50%" height="80%" align='center'>
			...
			<tr>
				<td rowspan="5" align="center">
					<p id="imgdisp"></p> <img id="img" width="100" height="100"
			...
			<tr>
				...
				<td>&nbsp;&nbsp;&nbsp; <input type="text" name="nickname"
					...
					required="required" title="닉네임은 문자 2자 이상입니다." /><div id="nicknameDiv"></div>
				...
				if (this.files && this.files[0]) {
					...
					if (ext.toLowerCase() == "jpg"
						...
						if (ext.toLowerCase() == "jpeg") {
							...
							document.getElementById("imgdisp").innerHTML = "이미지 파일만 업로드가 가능합니다.";
							document.getElementById("imgdisp").style.color='red';
							isCheck = false
							return;
						}
					}
